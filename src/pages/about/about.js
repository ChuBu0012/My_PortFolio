...
function about({mdleft}) {
  return (
    <div className="about flex justify-center items-center h-screen" id="about">
      <div className={`about-box flex flex-col items-center relative ${mdleft}`}>
        <h3 data-aos="zoom-in-down" data-aos-duration={500} className=" transition-all lg:text-7xl text-center text-headabout md:w-[350px] font-semibold lg:w-full leading-normal text-3xl ">
        ...
        <ul className="flex text-center justify-center items-center mt-2 mb-4 text-2xl lg:text-3xl font-semibold md:text-2xl md:mb-8 lg:mt-6">
          <li className=" mr-2 lg:mr-4">
            <a href="https://github.com/ChuBu0012" target="_blank" rel="noreferrer">
              <i className="fa-brands fa-github ih" />
            </a>
          </li>
          <li className=" mx-2 lg:mx-4">
            <a href="https://www.instagram.com/mo.st_to/" target="_blank" rel="noreferrer">
